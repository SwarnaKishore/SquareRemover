var colorsarray = ["rgb(93, 196, 61)","#d8a55e","rgb(252, 121, 252)","rgb(167, 170, 247)","rgb(242, 252, 21)","rgb(102,255,255)","rgb(187, 192, 182)","rgb(255,153,51)","rgb(187, 112, 236)","rgb(232, 185, 250)"];
	...
	for(var j=0; j < arrMatchingIds.length; j++)
	 {
		...
		document.getElementById(arrMatchingIds[j]).style.backgroundColor='#FFFFCC';
